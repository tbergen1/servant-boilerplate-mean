...
if (process.env.NODE_ENV && process.env.NODE_ENV === 'production') {
	var Servant = require('servant-sdk')(process.env.SERVANT_CLIENT_ID, process.env.SERVANT_SECRET_KEY, 'Enter Your Production Callback URL Here', 'v0');
} else {
	var Servant = require('servant-sdk')(config.servant.client_id, config.servant.client_secret, 'http://localhost:8080/auth/servant/callback', 'v0');
}
